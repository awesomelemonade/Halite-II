...
public class GameConstants {
	...
	/** Number of turns it takes to undock a ship */
	public static final int UNDOCK_TURNS = 5;

	/** Total production needed to create a ship*/
	public static final int TOTAL_PRODUCTION = 72;

	/** Production per docked ship */
	public static final int BASE_PRODUCTION = 6;
